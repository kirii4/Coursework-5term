package ermakov.onlinebanking.view.PaymentCasherForm;
...
public class PaymentCasherForm extends JDialog {
    ...
    public void exit(){
        setDefaultCloseOperation(PaymentCasherForm.HIDE_ON_CLOSE);
    }
