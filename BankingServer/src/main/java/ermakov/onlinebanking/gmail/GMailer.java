package ermakov.onlinebanking.gmail;
...
public class GMailer {
    ...
    public GMailer() throws Exception {
        ...
        service = new Gmail.Builder(httpTransport, jsonFactory, getCredentials(httpTransport, jsonFactory))
                .setApplicationName("Online Banking")
                .build();
    }
    ...
    private void sendMail(String sendEmail, String subject, String message) throws Exception {
        ...
        email.setFrom(new InternetAddress(sendEmail));
        email.addRecipient(TO, new InternetAddress(sendEmail));
